...
class = "imgtab">
<div><button class="botones">Rbase</button></div>
<p>Primeros pasos en el uso de R y Rstudio</p>
</div>
<div class="fix-item">
<img src="C:\Users\flavi\Desktop\aprendeR\Imagenes\broom.png"
class = "imgtab">
<div><button class="botones"><a href = https://flavioscargiali.github.io/aprendeR/02---dplyr.html"> Limpieza</a></button></div>
...
class = "imgtab">
<div><button class="botones">Visualización</button></div>
...
<a class = "links"><b>+</b> Inicio</a>
<br><a class = "links"><b>+</b> Limpieza</a>
<br><a class = "links"><b>+</b> Visualización</a>
