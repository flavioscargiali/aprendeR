...
<p> Introducción para conocer los principales conceptos de R, <br> el paradigma tidyverse y el armado de
<br>documentos con Rmarkdown
</p>
<div><button class="botones intro">INICIAR INTRODUCCIÓN</button></div>
</div>
...
class = "imgtab">
<div><button class="botones"><a class = "links" href = "https://flavioscargiali.github.io/aprendeR/01---introduccion.html"> Rbase</a ></button></div>
<p>Primeros pasos en el uso de R y Rstudio</p>
</div>
<div class="fix-item">
<img src="C:\Users\flavi\Desktop\aprendeR\Imagenes\broom.png"
class = "imgtab">
<div><button class="botones"><a class = "links" href = "https://flavioscargiali.github.io/aprendeR/02---dplyr.html"> Limpieza</a></button></div>
...
class = "imgtab">
<div><button class="botones"><a class = "links"  href = "https://flavioscargiali.github.io/aprendeR/03---ggplot.html"> Visualización</a></button></div>
<p>Primeros pasos en ggplot</p>
</div>
<div class="fix-item">
<img class = "imgtab" src="C:\Users\flavi\Desktop\aprendeR\Imagenes\placeholder.png">
<div><button class="botones">Geo</button></div>
<p>Manipulación de datos espaciales de la Argentina.
<b>¡Proximamente!</b></p>
</div>
<div class="fix-item">
<img class = "imgtab" src="C:\Users\flavi\Desktop\aprendeR\Imagenes\folder.png">
<div><button class="botones">Informe</button></div>
...
Licenciado en Ciencia Política (Universidad Nacional de La Matanza). Maestrando en Generación y Análisis
...
Sociólogo de la Universidad de Buenos Aires. Maestrando en Generación y Análisis de Información
Estadística por la UNTREF. Actualmente se desempeña como analista de visualización en Equifax S.A.
</div>
</div>
</div>
...
<br><a class = "links"><b>+</b> GEO</a>
<br><a class = "links"><b>+</b> Informe</a>
</div>
